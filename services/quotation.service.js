...
const templatePath = path.join(process.cwd(), "templates", "quotation.mustache");
const template = fs.readFileSync(templatePath, "utf8");

/**
 * Render HTML using mustache template
 */
function renderQuotationHtml(viewModel) {
 ...
 */
async function generateQuotationPdfBuffer(viewModel) {
  const html = renderQuotationHtml(viewModel);
    ...
    const pdfBuffer = await page.pdf({
        ...
        headerTemplate: `
            ...
            <div class="header-container">
                ...
                <div class="quotation-header-title">Quotation</div>
            </div>
        `,
